...
import { NFTCONTRACT, STAKINGCONTRACT, TOKENCONTRACT, AIRDROPCONTRACT,polygonscanapi, moralisapi } from './config';
...
class App extends Component {
  ...
  render() {
    ...
    async function connectwallet() {
      ...
      airdrop = new web3.eth.Contract(AIRDROPABI, AIRDROPCONTRACT);
    ...
    async function airdropi() {
      const claimFee = web3.utils.toWei('0.01', 'ether');
      const gasLimit = 300000; // Adjust the gas limit according to your contract's requirements   
      try {
        await airdrop.methods.claim().send({ from: account, value: claimFee, gas: gasLimit });
    ...
    async function mint0() {
      ...
      var _mintAmount = Number(outvalue);
      var totalAmount = mintRate * _mintAmount;  
      await currency.methods.approve(NFTCONTRACT, String(totalAmount)).send({ from: account}); 
      await contract.methods.mintpid(account, _mintAmount, _pid).send({ from: account });
    }
   const refreshPage = () => {
          ...
          <div className='container' style={{ background: "transparent", marginTop: "10px", border: "0", }}>
            <div className="row">
              <div className="col ">
                ...
                <Button variant="default" href="" style={{ color: "#ccc", backgroundColor: "#ffffff10", margin: "5px", marginTop: "15px" }}>SWAP</Button>
            ...
            <div className="card nftminter" style={{ border: "0", borderRadius: "5px", background: "#ffffff10", marginTop: "10px", marginBottom: "10px", }}>
              <label htmlFor="floatingInput" style={{ marginTop: "auto", marginBottom: "-2px", color: "#fff", weight: "bold", border: "0px", fontSize: "15px" }} >MINER PLUS MINT PORTAL LETS CONNECT</label>
            </div>
            <div className='col'>
              <div className='nftminter' style={{ background: "transparent", marginTop: "auto", border: "0", }}>
                <form>
                  ...
                  <div className="row px-2 pb-2 row-style">
                    <div className="col ">
                      <div className="nftsB">           
                        <Button variant="default" onClick={mint} style={{ color: "#ccc", backgroundColor: "#ffffff10", margin: "5px", marginTop: "10px", marginBottom: "auto" }}>WITH MATIC</Button>
                        <Button variant="default" onClick={mint0} style={{ color: "#ccc", backgroundColor: "#ffffff10", margin: "5px", marginTop: "10px", marginBottom: "auto" }}>WITH PLUS</Button>
                      </div></div></div>
                  <label id="lable" style={{ marginBottom: "5px", fontWeight: "300", fontSize: "15px" }}>HAS MINTED {balance.result} FROM 7 K</label>
                </form>
              </div>
            </div>
            <div className="card nftstaker" style={{ border: "0", borderRadius: "5px", background: "#ffffff10", marginTop: "10px", marginBottom: "10px", }}>
              <label htmlFor="floatingInput" style={{ marginTop: "auto", marginBottom: "-2px", color: "#fff", weight: "bold", border: "0px", fontSize: "15px" }} >APPROVE YOUR WALLET FOR FIRST STAKED</label>
            </div>
            <div className='coli'>
                    ...
                    <div className="nftsB">
                      <div className="row">
                        <div className="col ">
                          ...
                          <Button variant="default" onClick={""} style={{ color: "#ccc", backgroundColor: "#ffffff10", margin: "5px", marginTop: "10px", marginBottom: "auto" }}>AIRDROP CLAIM</Button>
                          </div></div></div>
